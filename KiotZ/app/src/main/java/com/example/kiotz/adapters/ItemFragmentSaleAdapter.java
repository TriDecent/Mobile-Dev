...
public class ItemFragmentSaleAdapter extends RecyclerView.Adapter<ItemFragmentSaleAdapter.MyViewHolder> {

    private final Context context;
    private final List<ItemFragment> itemFragments;

    public ItemFragmentSaleAdapter(Context context, List<ItemFragment> itemFragments) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.item_fragment_sale,parent,false);
        return new ItemFragmentSaleAdapter.MyViewHolder(view);
    }
